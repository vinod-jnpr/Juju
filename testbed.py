...
host1 = 'root@192.168.30.55'
host2 = 'root@192.168.30.56'
host3 = 'root@192.168.30.59'
...
control_data = {
    ...
    host2 : { 'ip': '192.168.40.49/24', 'gw' : '192.168.40.254', 'device':'nfp_p0' },
    host3 : { 'ip': '192.168.40.31/24', 'gw' : '192.168.40.254', 'device':'nfp_p0' },
    #host5 : { 'ip': '192.168.192.1/24', 'gw' : '192.168.192.254', 'device':'p6p2', 'vlan': '128' },
    #host6 : { 'ip': '192.168.192.2/24', 'gw' : '192.168.192.254', 'device':'p6p2', 'vlan': '128' },
